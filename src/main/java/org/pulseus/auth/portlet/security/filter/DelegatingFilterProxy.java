...
public class DelegatingFilterProxy extends GenericFilterBean {
	...
	private static final Logger log = LogManager.getLogger(DelegatingFilterProxy.class);
	...
	public void setTargetFilterLifecycle(boolean targetFilterLifecycle) {
		...
		log.debug("INSIDE setTargetFilterLifecycle for DelegatingFilterProxy.class");
	...
	protected boolean isTargetFilterLifecycle() {
		...
		log.debug("INSIDE isTargetFilterLifecycle for DelegatingFilterProxy.class");
	...
	protected void initFilterBean() throws ServletException {
		...
		log.debug("INSIDE initFilterBean for DelegatingFilterProxy.class");
		...
		synchronized (this.delegateMonitor) {
			if (this.delegate == null) {
				...
				log.debug("In init after web context");
				log.debug("Application Context: " + wac.getDisplayName());
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain filterChain)
		...
		log.debug("INSIDE doFilter for DelegatingFilterProxy.class");
	...
	protected WebApplicationContext findWebApplicationContext() {
		...
		log.debug("INSIDE findWebApplicationContext for DelegatingFilterProxy.class");
		log.debug("Context-name: " + getServletContext().getServletContextName());
		...
		log.debug("context attribute: " + getContextAttribute());
	...
	protected Filter initDelegate(WebApplicationContext wac) throws ServletException {
		...
		log.debug("INSIDE initDelegate for DelegatingFilterProxy.class");
	...
	protected void invokeDelegate(
		...
		log.debug("INSIDE invokeDelegate for DelegatingFilterProxy.class");
	...
	protected void destroyDelegate(Filter delegate) {
		...
		log.debug("INSIDE destroyDelegate for DelegatingFilterProxy.class");
